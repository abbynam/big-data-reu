...
########################################
    ...
    print("\nLoading 511")
    s511_path = '/umbc/rs/cybertrn/reu2025/team2/PG_DICOM_cat/1-item1_PG_cat.csv'
    singlesANon511 = getSinglesErgInit(s511_path)
    print(f"\t{s511_path}")
    d511_path = '/umbc/rs/cybertrn/reu2025/team2/PG_DICOM_cat/1-item1_PG_cat.csv'
    doublesANon511 = getDoublesErgInit(d511_path)
    print(f"\t{d511_path}")
    t511_path = '/umbc/rs/cybertrn/reu2025/team2/PG_DICOM_cat/1-item1_PG_cat.csv'        
    triplesANon511 = getTriplesErgInit(t511_path)
    print(f"\t{t511_path}")
    print("\nLoading PG")
    sPG_path  = '/umbc/rs/cybertrn/reu2025/team2/PG_DICOM_cat/1-item1_511.csv'
    singlesA511 = getSinglesErgInit(sPG_path)
    print(f"\t{sPG_path}")
    dPG_path  = '/umbc/rs/cybertrn/reu2025/team2/PG_DICOM_cat/1-item1_511.csv'
    doublesA511 = getDoublesErgInit(dPG_path)
    print(f"\t{dPG_path}")
    tPG_path  = '/umbc/rs/cybertrn/reu2025/team2/PG_DICOM_cat/1-item1_511.csv'
