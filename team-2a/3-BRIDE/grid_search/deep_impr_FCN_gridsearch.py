...
param_grid = {
    ...
    'patience' : [1500], 
    'num_layers':[256],
    'hidden_layers': [[256,256,256,256], [512, 448, 394, 192, 128, 64, 32, 16]], 
    'lr': [0.01], 
    'lr_step':[10], 
    'lr_gam':[0.1], 
    'dropout': [0],   
...
# === NEEDED PATHS ===
Template_path = '../../grid_search/deep_impr_FCN.yaml' #grid_search folder is stored in base
