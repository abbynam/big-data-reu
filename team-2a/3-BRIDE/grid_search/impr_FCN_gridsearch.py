...
param_grid = {
    'batch_size': [1024],  # change as needed
    ...
    'dropout': [0],  # change numbers and add to rows as necessary 
    'data_name': ['barajas'],  # change dataset names as needed
    'l2' : [0.01]
}

# === NEEDED PATHS ===
Template_path = '../../grid_search/impr_FCN.yaml' #grid_search folder is stored in base
